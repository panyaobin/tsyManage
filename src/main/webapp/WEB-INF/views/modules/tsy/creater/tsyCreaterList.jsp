...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="tsy:tsyCreater:edit"><li><a href="${ctx}/tsy/tsyCreater/form">市场部下单</a></li
		></shiro:hasPermission>
		<li class="active"><a href="${ctx}/tsy/tsyCreater/">下单登记表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tsyCreater" action="${ctx}/tsy/tsyCreater/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li>客户代码：<input type="text" name="cusName" value="" style="width: 8em">&nbsp;&nbsp;&nbsp;</li>
			<li>客户代码：<input type="text" name="cusName" value="" style="width: 8em">&nbsp;&nbsp;&nbsp;</li>
			<li>客户代码：<input type="text" name="cusName" value="" style="width: 8em">&nbsp;&nbsp;&nbsp;</li>
			<li>客户代码：<input type="text" name="cusName" value="" style="width: 8em">&nbsp;&nbsp;&nbsp;</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="tsyCreater" varStatus="num">
			<tr>
				...
				<td style="text-align: center">${tsyCreater.orderId}</td>
				<td style="text-align: center">${tsyCreater.type==0?"样品":"批量"}</td>
				<td style="text-align: center">${tsyCreater.orderSum}</td>
				...
				<shiro:hasPermission name="tsy:tsyCreater:edit"><td style="text-align: center">
    				<a href="${ctx}/tsy/tsyCreater/form?id=${tsyCreater.id}">修改</a>
