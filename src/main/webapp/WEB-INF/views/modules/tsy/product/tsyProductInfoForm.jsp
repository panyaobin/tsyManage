...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tsy/tsyProductInfo/">产品信息表列表</a></li>
		<shiro:hasPermission name="tsy:tsyProductInfo:edit"><li class="active"><a href="${ctx}/tsy/tsyProductInfo/form">产品信息表添加</a></li></shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tsyProductInfo" action="${ctx}/tsy/tsyProductInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<p style="font-size: 25px;text-align: center;width: 900px">产品信息录入</p>
		<br>
		<table  height="500px"; width="900px"; border="1px" style="text-align: center;">
			...
			<tr>
				...
				<td style="width: 100px;height: 25px;"><input name="createModel" style="width: 100px;font-weight: bolder;font-size: 16px;"
															  value="${tsyProductInfo.createModel}" type="text"></td>
				<td>宽</td>
