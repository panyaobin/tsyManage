...
<body>
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="tsy:tsyCreater:edit"><li  class="active"><a href="${ctx}/tsy/tsyWorker">工程部待制作</a></li
		></shiro:hasPermission>
		<li><a href="${ctx}/tsy/tsyWorker/form">工程部录入</a></li>
		...
		<c:forEach items="${page.list}" var="tsyCreater" varStatus="num">
			<tr>
				...
				<shiro:hasPermission name="tsy:tsyCreater:edit"><td style="text-align: center">
    				<a href="${ctx}/tsy/tsyWorker/form?createModel=${tsyCreater.createModel}&id=${tsyCreater.id}&type=${tsyCreater.type}">录入
					</a>
