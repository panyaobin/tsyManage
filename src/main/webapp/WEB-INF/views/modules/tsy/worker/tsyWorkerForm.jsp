...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="">工程部录入<shiro:lacksPermission
            name="tsy:tsyWorker:edit">查看</shiro:lacksPermission></a></li>
    <li><a href="${ctx}/tsy/tsyWorker/pass">工程部已制作</a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="tsyProductInfo" action="${ctx}/tsy/tsyWorker/save?error=${tsyCreater.id}"
           method="post"
    ...
    <br>
    <input type="text" name="type" value="${tsyCreater.type}">
    <table height="500px" ; width="900px" ; border="1px" style="text-align: center;">
        ...
        <tr>
            <td>生产型号</td>
            <td style="width: 100px;height: 25px;"><input name="createModel" style="width: 100px;font-weight: bolder;font-size: 16px;" value="${tsyCreater.createModel}" type="text"></td>
            <td>宽</td>
            <td><input name="wide" style="width: 100px;font-weight: bolder;font-size: 16px;" type="text" value="250"
                       tabindex="-1"></td>
            <td>长</td>
            <td style="width: 100px;height: 25px;"><input name="leng" style="width: 100px;font-weight: bolder;font-size:16px;" type="text"></td>
            <td>PNL-SET</td>
